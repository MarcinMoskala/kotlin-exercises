...
class ProductServiceTest {
    ...
    private val productService = ProductService(fakeProductRepository, testScope)

    @Test
    fun `observeProducts should emit distinct products`() = testScope.runTest {
    ...
    @Test
    fun `observeProducts should filter products by category`() = testScope.runTest {
    ...
    @Test
    fun `observeProducts should map product IDs to products`() = testScope.runTest {
    ...
    @Test
    fun `observeProducts should increment active observers on start and decrement on completion`() = testScope.runTest {
...
class FakeProductRepository : ProductRepository {
    ...
    override suspend fun fetchProduct(id: String): Product = products.first { it.id == id }
